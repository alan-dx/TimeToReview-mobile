    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.infoText}>{allReviews.length} {allReviews.length == 1 ? 'revisãoss' : 'revisões'}, {routines.length} {routines.length == 1 ? 'rotina' : 'rotinas'} e {subjects.length} {subjects.length == 1 ? 'matéria cadastrada' : 'matérias cadastradas'}</Text>
            </View>
